...
private: System::Void заданиеToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
	MessageBox::Show("Разработка программы вычисления экстремумов функции методом квадратичной интерполяции-экстраполяции\n\n"
		...
		"1.1 Среда программирования Visual C++.\n"
		"1.2. Проделать сравнительный анализ различных методов одномерного поиска.\n"
		"1.3. Найти экстремум функции F(x)- функцию оформить в виде отдельной подпрограммы.\n"
		"1.4. Предусмотреть ввод целевой функции, шага, количество шагов, начального значения x1=, погрешности результата (целевую функцию и параметры записать в различные файлы).\n"
	);
}
private: System::Void оПрограммеToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
	MessageBox::Show("Программа 'Разработка программы вычисления экстремумов функции методом квадратичной интерполяции-экстраполяции'\n"
...
private: System::Void руководствоПользователяToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
	MessageBox::Show("В левой части программы пользователю предлагается ввести данные: \n"
		"\t• функцию в виде подпрограммы\n"
		"\t• выбрать поиск максимума/минимума\n"
		"\t• ввести интервал (Х)\n"
		"\t• ввести точность вычислений (eps)\n"
		"\t• ввести шаг поиска (h)\n"
		"\t• ввести максимум итераций\n"
		"В правой части программы пользователь может увидеть результаты поиска: \n"
		"\t• значение Х\n"
		"\t• значение F(x)\n"
		"\t• за сколько шагов был выполнен поиск\n"
		"А так же 2 флага: \n"
		"\t• флаг достижения точности\n"
		"\t• флаг вида экстремума\n");
}
};
}
