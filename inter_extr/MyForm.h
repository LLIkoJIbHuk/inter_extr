...
namespace interextr {
	...
	private: System::Windows::Forms::ToolStripMenuItem^ ввод»сходныхƒанных»з‘айлаToolStripMenuItem;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->ввод»сходныхƒанных»з‘айлаToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			this->файлToolStripMenuItem->Text = L"¬ыход";
			// 
			// выходToolStripMenuItem
			// 
			this->выходToolStripMenuItem->Name = L"выходToolStripMenuItem";
			this->выходToolStripMenuItem->Size = System::Drawing::Size(136, 26);
			this->выходToolStripMenuItem->Text = L"¬ыход";
			this->выходToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::выходToolStripMenuItem_Click);
			// 
			// cthdbcToolStripMenuItem
			// 
			this->cthdbcToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(1) { this->ввод»сходныхƒанных»з‘айлаToolStripMenuItem });
			this->cthdbcToolStripMenuItem->Name = L"cthdbcToolStripMenuItem";
			this->cthdbcToolStripMenuItem->Size = System::Drawing::Size(59, 24);
			this->cthdbcToolStripMenuItem->Text = L"‘айл";
			// 
			// ввод»сходныхƒанных»з‘айлаToolStripMenuItem
			// 
			this->ввод»сходныхƒанных»з‘айлаToolStripMenuItem->Name = L"ввод»сходныхƒанных»з‘айлаToolStripMenuItem";
			this->ввод»сходныхƒанных»з‘айлаToolStripMenuItem->Size = System::Drawing::Size(320, 26);
			this->ввод»сходныхƒанных»з‘айлаToolStripMenuItem->Text = L"¬вод исходных данных из файла";
			this->ввод»сходныхƒанных»з‘айлаToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::ввод»сходныхƒанных»з‘айлаToolStripMenuItem_Click);
			// 
			// labelKind
			// 
			...
			this->labelKind->Text = L"‘лаг вида экстремума\?";
			// 
			// labelOK
			// 
			...
			this->labelOK->Text = L"‘лаг достижени€ точности";
			// 
			// textBox7
			// 
			...
			this->label7->Text = L"«а сколько шагов:";
			// 
			// textBox5
			// 
			...
			this->label6->Text = L"«начение F(x):";
			...
			this->label5->Text = L"«начение ’:";
			// 
			// openFileDialog
			// 
			this->openFileDialog->FileName = L"*.txt";
			this->openFileDialog->Filter = L"¬се файлы|*.*";
			// 
			// label1
			// 
			...
			this->label1->Text = L"¬вод функции";
			// 
			// label2
			// 
			...
			this->label3->Text = L"“очность вычислений (eps):";
			...
			this->label4->Text = L"Ўаг поиска (h):";
			// 
			// textBox3
			// 
			...
			this->label8->Text = L"ћаксимум итераций";
			// 
			// textBoxIterations
			// 
			...
			this->comboBoxMinimum->Items->AddRange(gcnew cli::array< System::Object^  >(2) { L"»скать минимум", L"»скать максимум" });
			...
			this->groupBox1->Text = L"–езультаты";
			// 
			// MyForm
			// 
			...
			this->Text = L"ћетод квадратичной интерпол€ции-экстрапол€ции";
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		//Ќайти и удалить файлы в каталогах \release и \debug 
		...
		//ƒобавить при необходимости кавычки
		if (ProjectName->IndexOf(" ") >= 0)
			ProjectName = "\"" + ProjectName + "\"";

		String^ ResultFile = Path::GetDirectoryName(Application::ExecutablePath) + "\\result.txt";
		if (File::Exists(ResultFile)) File::Delete(ResultFile); //”дал€етс€ результат
		//ƒобавить при необходимости кавычки
		...
		//«аписать параметры в Parametrs.h
		...
		if (File::Exists(ResultFile))
		{
			...
			labelOK->Text = (results[3] == "OK" ? "“очность достигнута" : "“очность не достигнута");

			if (comboBoxMinimum->SelectedIndex == 0)
				if (results[4] == "OK")
					labelKind->Text = "Ќайден минимум";
				else
					labelKind->Text = "ћинимум не найден, ближайший экстремум  - максимум!";
			else
				if (results[4] == "OK")
						labelKind->Text = "Ќайден максимум";
				else
					labelKind->Text = "ћаксимум не найден, ближайший экстремум  - минимум!";
		}
		else
		{
			textBox4->Text = "„то то пошло не так";
			return;
		}
		return;
	...
	private: System::Void ввод»сходныхƒанных»з‘айлаToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	private: System::Void textBox1_Leave(System::Object^ sender, System::EventArgs^ e) {
		...
		{
			MessageBox::Show("¬ходна€ строка имела неверный формат"); //MessageBox::Show(ex->Message, "¬ходна€ строка имела неверный формат");
			textBox1->Text = "-10";
		}
	}
